...
import MerkelizeUser from "../components/merkelize-user.tsx";

export default function MerkelizerPage() {
    const proofObj = {
        provider: 'uid-dob',
        ...
        ownerPublicKey: '0x8EF003Dd62c3bbD28FEdedDfd57cd48e169F58f3',
    ...
    return (
        <div>
            <h1>Merkelization Page</h1>
            <MerkelizeUser proofObj={proofObj} />
        </div>
    );
}